...
// Source: https://github.com/Ameba8195/Arduino/blob/master/hardware_v2/cores/arduino/font5x7.h
static byte font5x7[] = {
...
void loop() {
  for (int i = 0; i < 8; i++) { // For each custom character
